...
import { ApiTestRequest, HttpMethod, ContentType, HeaderItem, ParamItem } from '@/types/api-tester';
        ...
        <Form layout="vertical">
          ...
          <div style={{ display: 'flex', gap: '16px' }}>
            ...
            <Form.Item label="请求URL" style={{ flex: 1 }}>
              <Input
                placeholder="输入完整URL，如 https://api.example.com/users"
        ...
        <Tabs activeKey={activeTab} onChange={setActiveTab}>
          <TabPane tab="请求头" key="headers">
            ...
            <Table 
              ...
              dataSource={requestData.headers}
          ...
          <TabPane 
            tab="请求体" 
            key="body"
            disabled={requestData.method === HttpMethod.GET || requestData.method === HttpMethod.HEAD}
          >
            <JsonEditor
          ...
          <TabPane tab="高级选项" key="advanced">
            <Form layout="vertical">
              ...
              <Form.Item>
                <Switch 
                  checked={requestData.saveToHistory !== false} 
                  onChange={(checked) => onChange({ saveToHistory: checked })}
                /> 保存到历史记录
              </Form.Item>
            </Form>
          </TabPane>
