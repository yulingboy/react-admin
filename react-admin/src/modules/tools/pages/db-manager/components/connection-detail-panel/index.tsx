...
import { DatabaseColumn, DatabaseConnection, DatabaseTable } from '@/modules/tools/types/db-manager';
import SqlEditor from '../sql-editor';
import TableList from './table-list';
import TableStructure from './table-structure';
import TableData from './table-data';
import EmptyTableView from './empty-table-view';
import { getDatabaseTables, getTableData, getTableStructure } from '@/modules/tools/api/db-manager-api';
