...
import { CodeGeneratorColumn, QueryType, HtmlType } from '@/modules/tools/types/code-generator';
import { message } from '@/hooks/useMessage';
import { useDictionary } from '@/hooks/useDictionaryBack';
import { syncTableColumns, updateCodeGeneratorColumn } from '@/modules/tools/api/code-generator-api';
